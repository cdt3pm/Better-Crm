...
var service_api_wrapper_1 = require("./service_api_wrapper");
var ServiceCache = /** @class */ (function () {
    function ServiceCache(api) {
        this.api = api;
        this._allService = {};
    }
    ServiceCache.prototype.populate = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.api.backend.retrieve(new service_1.Service()).get().subscribe(this.add);
                return [2 /*return*/];
            });
        });
    };
    ServiceCache.prototype.add = function (record) {
        var service = new service_1.Service(record.attributes);
        var index;
        ...
        if (index.hasOwnProperty(service.name))
            ...
            index[service.name] = new service_api_wrapper_1.ServiceApiWrapper(service, this.api);
    };
    ServiceCache.prototype.get = function (name, collection) {
